...
public class StudentView {
    ...
    public void showMenu() {
        while (true) {
            ...
            int choice = Integer.parseInt(sc.nextLine()); // 버퍼 처리 안해도됨
    ...
    private void updateStudentView() {
        ...
        System.out.println(result ? "수정 완료!" : "해당 학생을 찾을 수 없습니다: " + studentNumber);
    }
    ...
    private void deleteStudentView() {
        ...
        System.out.println(result ? "삭제 완료!" : "해당 학생을 찾을 수 없습니다: " + studentNumber);
    }
}
