...
//      - 추가/제거: 공간에 대한 정리 (중간 삽입 시 나머지 요소를 한 칸씩 이동) >> 시간 복잡도가 발생 O(n)
...
public class B_List {
    public static void main(String[] args) {
        ...
        System.out.println(startTime); // 3839381303200
        ...
        // ArrayList 삽입 시간: 2171037000ns // LinkedList보다 삽입 시간 느림
