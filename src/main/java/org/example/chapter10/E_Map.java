...
// - 동일한 킼에 서로 다른 값 전달 시 기존 값이 새로운 값으로 덮어씌워짐
...
public class E_Map {
    public static void main(String[] args) {
        ...
        System.out.println(studentAges.keySet()); // 중복없이 반환 // [김지선, 홍기수]
        ...
        System.out.println(changeList); // [25, 20] // List 타입

        // entrySet(): Map의 키와 값은 Set으로 변환
