...
class SchoolPrincipal {
    ...
    // cf) 생성자: 반환타입 X, 접근제한가 가능, 이름은 클래스명과 동일
...
public class D_Singleton {
    public static void main(String[] args) {
        ...
        System.out.println(example1); // org.example.chapter13.Example@404b9385
        System.out.println(example2); // org.example.chapter13.Example@6d311334
        System.out.println(example3); // org.example.chapter13.Example@682a0b20
