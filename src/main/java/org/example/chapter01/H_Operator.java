...
public class H_Operator {
    public static void main(String[] args) {
        ...
        System.out.println(drink + "을(를) 마십니다."); // 맥주을(를) 마십니다.

        age = 10;
        drink = age > 19 ? "맥주" : "오렌지주스";
        System.out.println(drink + "을(를) 마십니다."); // 오렌지주스을(를) 마십니다.

        int x = 10, y = 20; // 변수의 데이터 타입이 같은 경우 , 콤마로 구분하여 나열 가능
        System.out.println(x % y == 0 ? "2의 배수입니다" : "2의 배수가 아닙니다."); // 2의 배수가 아닙니다.
