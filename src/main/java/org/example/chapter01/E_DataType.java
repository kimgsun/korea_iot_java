...
public class E_DataType {
    public static void main(String[] args) {
        /*
            ...
            cf) Stack(스택) : 기본타입의 데이터가 실제 저장 / 참조타입의 주소값이 저장(되는 공간)
                Heap(힙) : 참조타입의 실제 데이터가 저장(되는 공간)
         */
        ...
        // 1) float : (정수포함) 약 7자리 정도까지 정확하게 표현
        float f1 = 123.456789F;
        System.out.println(f1); // 123.45679 - 소수점 자리가 반올림 처리

        // 2) double : (정수포함) 약 15~16자리 정도까지 정확하게 표현
        ...
        String welcomeMassge = "만나서 반갑습니다 :)";
        System.out.println(welcomeMassge);
        ...
        //      변수 선언과 본인의 데이터로 초기화
        String studentName = "김지선";
        int studentAge = 28;
        int studentHeight = 164;
