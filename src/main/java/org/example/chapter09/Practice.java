...
public class Practice {
    public static void main(String[] args) {
        ...
        // : 프론트엔드에서 입력받는 ID, PW, 생년월일 등은 ""로 문자열로 입력되어 들어옴
        // > 형태를 파악해서 포맷팅해야함
        ...
        // 6. 남은 일수 계산
        // ChronoUnit.Days: java.time 패키지에서 날짜와 시간 간의 차이를 게산할 때 사용
        // .between(a, b): a와 b 사이의 날짜 | 시간 차이를 반환
        long daysUtilNextBirthday = ChronoUnit.DAYS.between(today, nextBirthDay); // 모든 값을 숫자값으로 반환
