...
public class D_While {
    public static void main(String[] args) {
        ...
        // for문으로 1부터 5까지 출력하는 문장을 작성 (초기화는 1)
        ...
        // == 예제 == //
        // : 사용자의 입력을 받아서 1 ~ 10 사이의 숫자가 입력될 때까지 반복
        // : do-while문으로 작성
        ...
        } while (inputNumber < 1 || inputNumber > 10); // 1 ~ 10 사이의 경우 반복문 종료
