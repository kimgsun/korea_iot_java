...
class Restaurant {
    ...
    void placeOrder(String dish, String speialRequests) {
        System.out.println(dish + " - " + speialRequests);
    }

    void placeOrder(String dish, int quantity, String speialRequests) {
        System.out.println(dish + " * " + quantity + " - " + speialRequests);
    }
}
